 ...
 * These functions should be all you need from this library
 */
public class BitMap_Helpers {
    ...
    /**
     * merge the color bmpColor with bmpThresholded, pixel by pixel
     * if bmpThresholded pixel is white then use color in  bmpColor
     * if bmpThresholded pixel is black then use black in  bmpColor
     *
     * @param bmpColor   overwritten with merged color/thresholded combo
